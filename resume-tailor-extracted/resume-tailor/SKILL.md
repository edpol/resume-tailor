...
4. **Upload the tailored resume** as a Google Doc:
   - Title: `Edward Pol Resume -- <Company> (Tailored)`
   - `contentMimeType: text/plain`
   - Full resume text with the rewritten HIGHLIGHTS bullets substituted in
5. **Upload the job description** as a Google Doc:
   - Title: `Job Description -- <Company> <Role Title>`
   - `contentMimeType: text/plain`

**Do NOT upload .docx or .pdf files to Google Drive.** Plain text uploads that convert
to Google Docs are fast and reliable. Binary file uploads are slow and prone to timeouts.
